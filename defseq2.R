...
library(pathview)
library(ggupset)
cts<- read.csv("C:/Users/jrobl/OneDrive - University of Florida/Documents/MASTER Thesis/Transcriptomics_Tony/Nimphs/gene_count_matrix_D_CITRI.csv",row.names = 1)
coldata<- read.csv("C:/Users/jrobl/OneDrive - University of Florida/Documents/MASTER Thesis/Transcriptomics_Tony/Nimphs/Names_of_samples.csv")
...
#write.table(deGenes_DB$Gene_ID_BLAST_search[which(!is.na(deGenes_DB$Gene_ID_BLAST_search))], "./annotatated_DEGs_genes.txt", row.names = F, col.names = F)
query_NCBI<- read.delim("./query_NCBI.txt")
...
setwd("C:/Users/jrobl/OneDrive - University of Florida/Documents/MASTER Thesis/Transcriptomics_Tony/KEGG_Pathways/")
for (i in kk2@result$ID[kk2@result$ID!="dci01240"]) {
  dme <- pathview(gene.data=kegg_gene_list, pathway.id=i, species = kegg_organism)
}
setwd("C:/Users/jrobl/OneDrive - University of Florida/Documents/MASTER Thesis/Transcriptomics_Tony/")
